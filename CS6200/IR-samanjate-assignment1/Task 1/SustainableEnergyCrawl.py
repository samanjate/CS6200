...
def getSeedUrl():
    return "https://en.wikipedia.org/wiki/Sustainable_energy";
...
urlsss = open('ir-samanjate-q1.txt', 'a') # the urls are stored in this file
urlsss.write(url) # storing Sustainable_energy url
