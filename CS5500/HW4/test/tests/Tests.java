...
public class Tests {
	...
	/**
     * Method for creating a sorter. Please note that this method might not 
     * follow the expected behaviour of the Sorters I am aiming to build, hence
     * some of the test cases written might fail.
     * 
